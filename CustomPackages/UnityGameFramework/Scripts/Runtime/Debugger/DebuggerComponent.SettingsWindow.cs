    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        private sealed class SettingsWindow : ScrollableDebuggerWindowBase
        {
            ...
            public override void Initialize(params object[] args)
            {
                ...
                _debuggerComponent.WindowScale = _lastWindowScale = _settingComponent.GetFloat("Debugger.Window.Scale", DefaultWindowScale);
                _debuggerComponent.IconRect = new Rect(_lastIconX, _lastIconY, DefaultIconRect.width, DefaultIconRect.height);
                _debuggerComponent.WindowRect = new Rect(_lastWindowX, _lastWindowY, _lastWindowWidth, _lastWindowHeight);
            }
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        {
                            _debuggerComponent.WindowRect = new Rect(_debuggerComponent.WindowRect.x, _debuggerComponent.WindowRect.y, width, _debuggerComponent.WindowRect.height);
                        }
                    }
                    GUILayout.EndHorizontal();
                    ...
                    GUILayout.BeginHorizontal();
                    {
                        ...
                        {
                            _debuggerComponent.WindowRect = new Rect(_debuggerComponent.WindowRect.x, _debuggerComponent.WindowRect.y, _debuggerComponent.WindowRect.width, height);
                        }
                    }
                    GUILayout.EndHorizontal();
