...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class LocalizationComponent : GameFrameworkComponent
    {
        ...
        [FormerlySerializedAs("_EnableLoadDictionaryUpdateEvent")] [SerializeField]
        private bool enableLoadDictionaryUpdateEvent = false;

        [FormerlySerializedAs("_EnableLoadDictionaryDependencyAssetEvent")] [SerializeField]
        private bool enableLoadDictionaryDependencyAssetEvent = false;

        [FormerlySerializedAs("_LocalizationHelperTypeName")] [SerializeField]
        private string localizationHelperTypeName = "UnityGameFramework.Runtime.DefaultLocalizationHelper";

        [FormerlySerializedAs("_CustomLocalizationHelper")] [SerializeField]
        private LocalizationHelperBase customLocalizationHelper = null;
        ...
        /// 获取字典数量。
        /// </summary>
        public int DictionaryCount => _localizationManager.DictionaryCount;

        /// <summary>
        /// 获取缓冲二进制流的大小。
        /// </summary>
        public int CachedBytesSize => _localizationManager.CachedBytesSize;
        ...
        protected override void Awake()
        {
            ...
            if (enableLoadDictionaryUpdateEvent)
            {
                _localizationManager.ReadDataUpdate += OnReadDataUpdate;
            }

            if (enableLoadDictionaryDependencyAssetEvent)
            {
                _localizationManager.ReadDataDependencyAsset += OnReadDataDependencyAsset;
            }
        }
        ...
        private void Start()
        {
            ...
            {
                _localizationManager.SetResourceManager(baseComponent.EditorResourceHelper);
            }
            else
            {
            ...
            LocalizationHelperBase localizationHelper = Helper.CreateHelper(localizationHelperTypeName, customLocalizationHelper);
            ...
            _localizationManager.Language = baseComponent.EditorResourceMode && baseComponent.EditorLanguage != Language.Unspecified ? baseComponent.EditorLanguage : _localizationManager.SystemLanguage;
        ...
        {
            _localizationManager.ReadData(dictionaryAssetName);
        }
        ...
        {
            _localizationManager.ReadData(dictionaryAssetName, priority);
        }
        ...
        {
            _localizationManager.ReadData(dictionaryAssetName, userData);
        }
        ...
        {
            _localizationManager.ReadData(dictionaryAssetName, priority, userData);
        }
        ...
        {
            _eventComponent.Fire(this, LoadDictionaryUpdateEventArgs.Create(e));
        }

        private void OnReadDataDependencyAsset(object sender, ReadDataDependencyAssetEventArgs e)
        {
            _eventComponent.Fire(this, LoadDictionaryDependencyAssetEventArgs.Create(e));
        }
    }
}
